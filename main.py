...
async def text_to_gif(text: str, theme: str="dark", custom_text_color="#FFFFFF", body_color="#000000", custom_icon=None):
    if theme.lower() == "light":
        ...
        announce_mask = (await img("https://cdn.discordapp.com/attachments/1043603765212749944/1128681074743058452/Untitled186_20230712190358.png")).copy()
        announce_bg = (await img("https://cdn.discordapp.com/attachments/1043603765212749944/1128681074290081882/Untitled186_20230712190350.png")).copy()
        text_color = "#FFFFFF"
        ...
        announce_mask.paste(new_mask, mask=announce_mask)
        announce_bg.paste(new_mask, mask=announce_bg)
